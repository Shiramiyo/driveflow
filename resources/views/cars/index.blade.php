    ...
    <section class="section-space">
        <div class="page-width">
            <div class="mb-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-2xl">
                    <span class="eyebrow">Car listing page</span>
                    <h1 class="display-title mt-5 text-3xl sm:text-4xl">Filter by price, brand, seats, fuel type, and pickup style.</h1>
                    <p class="section-copy mt-4">
                        This page follows your PDF requirement directly and adds a Turo-like side filter layout that still feels clean on mobile.
                    </p>
                </div>
                ...
                <aside class="shell-panel p-6">
                    <div class="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <h2 class="mt-2 text-2xl font-semibold text-white">Find your fit</h2>
                        </div>
                    ...
                    <form action="{{ route('cars.index') }}" method="GET" class="space-y-6">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
                            ...
                            <div>
                                <label for="pickup_option" class="field-label">Pick up option</label>
                ...
                <div class="space-y-6">
                    <div class="flex flex-col gap-4 rounded-3xl border border-white/10 bg-white/5 p-5 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-lg font-semibold text-white">Dates: {{ \Carbon\Carbon::parse($defaultStartAt)->format('M d, H:i') }} to {{ \Carbon\Carbon::parse($defaultEndAt)->format('M d, H:i') }}</p>
                        </div>
                        <div class="pill">MySQL-ready filters · Blade UI</div>
                    </div>
                    ...
                    @if ($cars->count())
                        ...
                        @if ($cars->hasPages())
                            <div class="flex items-center justify-between rounded-3xl border border-white/10 bg-white/5 p-4">
                    ...
                    @else
                        <div class="shell-panel p-10 text-center">
                            ...
                            <p class="mx-auto mt-4 max-w-xl text-sm leading-6 text-slate-300">
                                Try widening the price range, removing a few checkboxes, or switching to another city.
                            </p>
