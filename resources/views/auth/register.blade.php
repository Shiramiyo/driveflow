<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="driver_license_number" class="block mt-1 w-full" type="text" name="driver_license_number" :value="old('driver_license_number')" required autocomplete="off" />
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="text-sm text-white/70 transition hover:text-white" href="{{ route('login') }}">
